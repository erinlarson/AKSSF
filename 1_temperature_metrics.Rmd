...
# saveRDS(mets11_tr, file = "output/temp_mets11_wTR.rds")
...
mets11_env <- mets11_tr %>% 
  select(Region:Rearing, grp_6) %>% 
...
autoplot(pc2, data = mets11_env, colour = 'grp6f', labels = TRUE, loadings.label = TRUE, 
         loadings.label.colour = "black", loadings.label.repel = TRUE, loadings.colour = "black") +
  theme_bw()
