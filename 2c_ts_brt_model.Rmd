...
Save a copy of the final TS along with 13 covariates for Dustin to add to the mapper. Include lat/long from md file so he can plot.
...
dat %>% 
  ...
  dplyr::select(SiteID = Site, Year, TempSens_Air.DayLen, str_slope, 
                ...
                wtd_lcld_jd, summer_precip, Region, Latitude, Longitude) %>% 
...
brt_step <- readRDS("output/brt_dfa1tr_air2022-05-10.rds")
...
hu12_dm <- read_csv("data_preparation/HUC12_cat_pts_missing_daymet_2011-19.csv") %>% 
  as_tibble()
