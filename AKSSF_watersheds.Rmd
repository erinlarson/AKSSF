...
```{r}
fl <- read_sf(dsn = "W:/GIS/NHDPlus_20201216/extracts/NHDPLUS_H_19020301_HU8_GDB.gdb", layer = "NHDFlowline")

cat <- read_sf(dsn = "W:/GIS/NHDPlus_20201216/extracts/NHDPLUS_H_19020301_HU8_GDB.gdb", layer = "NHDPlusCatchment")

vaa <- read_sf(dsn = "W:/GIS/NHDPlus_20201216/extracts/NHDPLUS_H_19020301_HU8_GDB.gdb", layer = "NHDPlusFlowlineVAA")
```
