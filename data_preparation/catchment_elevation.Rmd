...
Script to calculate elevation statistics over each catchment. Using 10 m elevation grids that Timm put on J drive. J:\GIS_data\topography\Terrestrial\Composite_10m_Beringia
Dustin used these composites to create the synthetic networks and can create regional composities for Cook Inlet and Copper River so we have the same elevation data for all regions and elevation covariates.

First testing for NHDPlus in Cook Inlet only.
