...
source('W:/Github/AKSSF/day_and_month_functions.R')
...
deshka_temp <- temp_msmt_freq(deshka_temp)
deshka_daily <- daily_screen(deshka_temp)
...
Remove sites in Sue's other dataset and save file in the final data folder.

```{r}
dup_sites <- readRDS("data_preparation/duplicate_CIK_sites.rds")
