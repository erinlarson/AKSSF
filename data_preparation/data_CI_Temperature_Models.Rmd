...
# READ IN DUPLICATE SITES FROM sUE'S COMPLETE DATASET AND REMOVE HERE.
Note on sites with metadata in AKOATS. All Deshka sites are new. The Kenai sites and CIK14 in the Anchor are included in Sue's other dataset with additional years of data. The Anchor River watershed sites CIK1-CIK8 are distinct and don't have metadata in AKOATS.
