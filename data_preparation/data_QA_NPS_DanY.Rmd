...
npsDanY.data <- mutate_if(npsDanY.data,
                           is.character,
                           str_replace_all, pattern = "Six_Mile_Outlet", replacement = "NPS_Six_Mile_Outlet")

npsDanY.data <- mutate_if(npsDanY.data,
                           is.character,
                           str_replace_all, pattern = "Chulitna_SiteB", replacement = "NPS_Chulitna_SiteB")
npsDanY.data <- mutate_if(npsDanY.data,
                           is.character,
                           str_replace_all, pattern = "Little_Kijik_River_Dan", replacement = "NPS_Little_Kijik_River_Dan")
npsDanY.data <- mutate_if(npsDanY.data,
                           is.character,
                           str_replace_all, pattern = "Tazimina_Dan", replacement = "NPS_Tazimina_Dan")
npsDanY.data <- mutate_if(npsDanY.data,
                           is.character,
                           str_replace_all, pattern = "Newhalen_River", replacement = "NPS_Newhalen_River")
npsDanY.data <- mutate_if(npsDanY.data,
                           is.character,
                           str_replace_all, pattern = "Hardenburg_Bay", replacement = "NPS_Hardenburg_Bay")

# add year column and populate date
npsDanY.data <- mutate(npsDanY.data,
...
npsd2_sites <- npsDanY.data.qc %>% distinct(SiteID, year) %>% arrange(SiteID, year)
...
Sites:
"NPS_Chulitna_SiteB", "NPS_Six_Mile_Outlet", "NPS_Hardenburg_Bay", "NPS_Little_Kijik_River_Dan", "NPS_Newhalen_River"
...
p <- npsDanY.data.qc %>% 
  ...
  filter(SiteID == "NPS_Newhalen_River", UseData == 1) #filtered by site
