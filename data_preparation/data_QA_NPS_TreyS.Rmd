...
npsTreyS.data <- mutate_if(npsTreyS.data,
                           is.character,
                           str_replace_all, pattern = "Caribou Creek", replacement = "NPS_Caribou Creek")
npsTreyS.data <- mutate_if(npsTreyS.data,
                           is.character,
                           str_replace_all, pattern = "Long Lake Creek", replacement = "NPS_Long Lake Creek")
npsTreyS.data <- mutate_if(npsTreyS.data,
                           is.character,
                           str_replace_all, pattern = "Rock Creek WRST", replacement = "NPS_Rock Creek WRST")
npsTreyS.data <- mutate_if(npsTreyS.data,
                           is.character,
                           str_replace_all, pattern = "Crystal Creek", replacement = "NPS_Crystal Creek")
npsTreyS.data <- mutate_if(npsTreyS.data,
                           is.character,
                           str_replace_all, pattern = "Lakina River", replacement = "NPS_Lakina River")
npsTreyS.data <- mutate_if(npsTreyS.data,
                           is.character,
                           str_replace_all, pattern = "Gilahina River", replacement = "NPS_Gilahina River")
npsTreyS.data <- mutate_if(npsTreyS.data,
                           is.character,
                           str_replace_all, pattern = "Rufus Creek", replacement = "NPS_Rufus Creek")
...
Sites:
"NPS_Caribou Creek", "NPS_Crystal Creek", "NPS_Gilahina River", "NPS_Lakina River", 
"NPS_Long Lake Creek", "NPS_Rock Creek WRST", "NPS_Rufus Creek"
...
p <- npsTreyS.data.qc %>% 
  filter(SiteID == "NPS_Caribou Creek", UseData == 1)
...
nve_sites <- npsTreyS.data.finalqc %>% distinct(SiteID, year) %>% arrange(SiteID, year)
...
for(i in 1:nrow(nve_sites)) {
  dat <- left_join(nve_sites %>% slice(i), npsTreyS.data.finalqc)
