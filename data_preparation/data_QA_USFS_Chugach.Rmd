...
p <- usfsChug.data.qc %>% 
  filter(SiteID == "USFS_Pigot Bay Spawn Channel")
...
# Save Data
```{r}
# Set output name for save functions - will be appended with appropriate date and suffix 
acronym = "usfsChug"
...
usfsChug.data.finalqc %>% 
  ...
  saveRDS("formatted_data/usfsChug.data.finalqc")
