...
DM:  Removed 03/05/2021 - USFS_Pigot Bay Spawn Channel & USFS_Rude River SC & Sheep River due to tidal influence
...
p <- usfsChug.data.qc %>% 
  filter(SiteID == "USFS_Middle Arm Eyak", UseData == 1)
