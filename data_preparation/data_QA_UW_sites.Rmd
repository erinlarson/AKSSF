...
uw.climStat <- c("USR0000AKIL")

uw.climDat <- tibble( name = c( "KILBUCK ALASKA, AK US"),
                 id = uw.climStat)
...
pdf("data_preparation/UW 16 Raw Data.pdf", width = 11, height = 8.5)
