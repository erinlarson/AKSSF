...
final_data %>% 
  filter(SiteID == "UW_Nerka Sam Creek" & year(sampleDate) == 2013) 

saveRDS(final_data2, paste0("data_preparation/final_data/summer_data_wair", Sys.Date(), ".rds"))
write_csv(final_data2, path = paste0("data_preparation/final_data/summer_data_wair", Sys.Date(), ".csv"))
```
