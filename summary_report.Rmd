...
Alternatively, it may be more interesting to see if averaging over the catchment reduced variability in air temperatures from day to day.

```{r}
air_comp %>% distinct(SiteID) %>% arrange(SiteID)
